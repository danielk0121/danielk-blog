...
- [x] 게시글 정렬 기준 파악 및 제어
- [x] 배포 브랜치 분리
- [x] 문서 내용 분석으로, 태그 자동 입력 기능 못하는가 ?
- [x] 모바일 환경 개선 > 폰트 크기 줄이기
- [x] 모바일 환경 개선 > 테이블 내 폰트 크기가 너무 큼
- [x] 태그 디자인 변경 > 해시태그(#) 가 없는데, 해시태그 위주로 태그 변경
- [x] SNS 노출 og:xxx 태그 수정 및 반영 테스트
- [ ] 여러 문서들을 한 폴더에 모아서 분류 할 수 있나 ?
- [ ] 폰에서 간략히 초안 작성할 수 있는 기능 개발 (트위터, 메모장 처럼)
- [ ] 페이지 조회수 등 통계 기능 추가 : [add_ga.md](doc/todo_task_md/add_ga.md)
- [ ] 파비콘 이미지 등록
- [ ] 페이징 more 기능 추가
